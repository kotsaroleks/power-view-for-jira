...
function formatSprintRange(sprint: JiraSprint): string {
...
function sprintTimeNote(sprint: JiraSprint): string {
  if (!sprint.endDate) {
...
export function BoardHealthReportView({
  ...
  return (
    <section id="reports" className="report-workspace" aria-labelledby="report-title">
