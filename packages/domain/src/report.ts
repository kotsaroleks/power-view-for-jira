import type { JiraIssueSprint, NormalizedIssue } from "./jira-issue";
...
function uniqueSprints(issues: NormalizedIssue[]): JiraIssueSprint[] {
  const byId = new Map<string, JiraIssueSprint>();
